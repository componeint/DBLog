<?php
/**
 * DBLogEventListener.php
 * Created by @rn on 1/3/2017 4:05 PM.
 */

namespace App\Components\DBLog\Listeners;

use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Log;
use Carbon\Carbon;
use App\Components\DBLog\Models\DBLog;
use Jenssegers\Agent\Agent;
use Illuminate\Support\Facades\Auth;

class DBLogEventListener
{
    private $agent;
    ...
    {
        $events->listen('event.emergency', 'App\Components\DBLog\Listeners\DBLogEventListener@onEmergency', 10);
        $events->listen('event.alert', 'App\Components\DBLog\Listeners\DBLogEventListener@onAlert', 10);
        $events->listen('event.critical', 'App\Components\DBLog\Listeners\DBLogEventListener@onCritical', 10);
        $events->listen('event.error', 'App\Components\DBLog\Listeners\DBLogEventListener@onError', 10);
        $events->listen('event.warning', 'App\Components\DBLog\Listeners\DBLogEventListener@onWarning', 10);
        $events->listen('event.notice', 'App\Components\DBLog\Listeners\DBLogEventListener@onNotice', 10);
        $events->listen('event.info', 'App\Components\DBLog\Listeners\DBLogEventListener@onInfo', 10);
        $events->listen('event.debug', 'App\Components\DBLog\Listeners\DBLogEventListener@onDebug', 10);
    }
